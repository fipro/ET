...
%interpolate phytoplankton conc. for actual agent position
%P_a(nr,t)=interp1(param.z,P(t-1,1:end),(a(nr).pos(t-1)*param.dz));

%interpolate light for actual agent position
%I_a(nr,t)=interp1(param.z,I(1:end),(a(nr).pos(t-1)*param.dz));
